...
aws secretsmanager create-secret --name "/cafe/showServerInfo2" --secret-string "false"
aws secretsmanager create-secret --name "/cafe/timeZone2" --secret-string "America/New_York"
aws secretsmanager create-secret --name "/cafe/currency2" --secret-string "$"
aws secretsmanager create-secret --name "/cafe/dbUrl2" --secret-string $publicDNS
aws secretsmanager create-secret --name "/cafe/dbName2" --secret-string "cafe_db"
aws secretsmanager create-secret --name "/cafe/dbUser2" --secret-string "admin"
aws secretsmanager create-secret --name "/cafe/dbPassword2" --secret-string "Lab123#"
